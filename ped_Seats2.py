...
class InitPeople(pyflamegpu.HostFunction):
    def run(self, FLAMEGPU):
        ...
        if(people.count() > 0):
            ...
            def choose_seat_waiting_location_concentrated():
                x = FLAMEGPU.random.uniformInt(182, 218) / 10.0   # x = 18.2~21.8
                y = FLAMEGPU.random.uniformInt(494, 620) / 100.0     # y = 4.94~6.2
                return x, y
            ...
            seat_capacity = 12  # 4 seats of three people 
            ...
            for i in range(20):
                ...
                if i < seat_capacity:
                  wait_x, wait_y = choose_seat_waiting_location_concentrated()
                ...
                t.setVariableInt("dwell", 1, 99999) # is set to the end of the simulation.
